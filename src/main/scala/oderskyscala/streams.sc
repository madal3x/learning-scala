...
object streams {
  ...
  (1000 to 10000).toStream filter (_ % 2 == 0) take 2 // next of Stream is evaluated on demand (through Stream.cons call-by-name parameter
  ...
  def listRange(lo: Int, hi: Int): List[Int] =
  	...
  	val s1 = (1 to 5).toStream                //> s1  : scala.collection.immutable.Stream[Int] = Stream(1, ?)
  	val s2 = (6 to 9).toList                  //> s2  : List[Int] = List(6, 7, 8, 9)
